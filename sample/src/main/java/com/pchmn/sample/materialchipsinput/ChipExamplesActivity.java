...
public class ChipExamplesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChip1.setOnChipClicked(view -> {
            Toast.makeText(ChipExamplesActivity.this, mChip1.getLabel() + ": clicked",
                           Toast.LENGTH_SHORT).show();
        });
        mChip1.setOnDeleteClicked(view -> {
            Toast.makeText(ChipExamplesActivity.this, mChip1.getLabel() + ": delete clicked",
                           Toast.LENGTH_SHORT).show();
        });

        // chip 2
        mChip2.setOnChipClicked(view -> {
            Toast.makeText(ChipExamplesActivity.this, mChip2.getLabel() + ": clicked",
                           Toast.LENGTH_SHORT).show();
        });
        ...
        mChip3.setOnChipClicked(view -> {
            Toast.makeText(ChipExamplesActivity.this, mChip3.getLabel() + ": clicked",
                           Toast.LENGTH_SHORT).show();
        });
        mChip3.setOnDeleteClicked(view -> {
            Toast.makeText(ChipExamplesActivity.this, mChip3.getLabel() + ": delete clicked",
                           Toast.LENGTH_SHORT).show();
        });

        // chip 4
        mChip4.setOnChipClicked(view -> {
            Toast.makeText(ChipExamplesActivity.this, mChip4.getLabel() + ": clicked",
                           Toast.LENGTH_SHORT).show();
        });
        mChip4.setOnDeleteClicked(view -> {
            Toast.makeText(ChipExamplesActivity.this, mChip4.getLabel() + ": delete clicked",
                           Toast.LENGTH_SHORT).show();
        });

        // chip 5
        mChip5.setOnChipClicked(view -> {
            Toast.makeText(ChipExamplesActivity.this, mChip5.getLabel() + ": clicked",
                           Toast.LENGTH_SHORT).show();
        });

        // chip 6
        mChip6.setOnChipClicked(view -> {
            Toast.makeText(ChipExamplesActivity.this, mChip6.getLabel() + ": clicked",
                           Toast.LENGTH_SHORT).show();
        });
        mChip6.setOnDeleteClicked(view -> {
            Toast.makeText(ChipExamplesActivity.this, mChip6.getLabel() + ": delete clicked",
                           Toast.LENGTH_SHORT).show();
        });

        // chip 7
        mChip7.setOnChipClicked(view -> {
            Toast.makeText(ChipExamplesActivity.this, mChip7.getLabel() + ": clicked",
                           Toast.LENGTH_SHORT).show();
        });
        mChip7.setOnDeleteClicked(view -> {
            Toast.makeText(ChipExamplesActivity.this, mChip7.getLabel() + ": delete clicked",
                           Toast.LENGTH_SHORT).show();
        });
